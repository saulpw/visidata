...
- For non-numerical columns `z|` followed by **not ColumnName**, will select all empty cells and null cells for that column. For numerical columns it will also select cells with `0`.
