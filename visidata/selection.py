...
Sheet.addCommand(',', 'select-equal-cell', 'select(gatherBy(lambda r,c=cursorCol,v=cursorDisplayValue: c.getDisplayValue(r) == v), progress=False)', 'select rows matching current cell in current column')
