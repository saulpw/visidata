...
PyobjSheet.addCommand('v', 'visibility', 'sheet.options.visibility = 0 if sheet.options.visibility else 2; reload()')
PyobjSheet.addCommand('gv', 'show-hidden', 'sheet.options.visibility = 2; reload()')
PyobjSheet.addCommand('zv', 'hide-hidden', 'sheet.options.visibility -= 1; reload()')
