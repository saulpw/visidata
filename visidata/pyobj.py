...
BaseSheet.addCommand('', 'define-command', 'v=input("longname execstr: "); longname, execstr = v.split(" ", maxsplit=1); sheet.addCommand("", longname, execstr)', 'define a new command with the given longname and Python execstr')
