...
class DescribeSheet(Sheet):
    ...
    commands = [
        ...
        Command('!', 'source.toggleKeyColumn(cursorRow)', 'toggle current column as a key column on source sheet'),
        Command('z!', 'source.keyCols.remove(cursorRow)', 'unset current column as a key column on source sheet')
    ]
    colorizers = [
