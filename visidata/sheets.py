...
Sheet.addCommand('e', 'edit-cell', 'cursorCol.setValues([cursorRow], editCell(cursorVisibleColIndex)) if cursorRow else fail("no rows to edit")', 'edit contents of current cell')
