...
BaseSheet.addCommand('Q', 'quit-sheet-free',  'rows.clear(); sheet.source.lines.clear(); vd.allSheets.remove(sheet); vd.quit(sheet)', 'discard current sheet and free memory')
