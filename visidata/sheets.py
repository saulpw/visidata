...
BaseSheet.addCommand('Q', 'quit-sheet-free',  'rows.clear(); vd.releaseMemory(sheet.source); vd.allSheets.remove(sheet); vd.quit(sheet)', 'discard current sheet and free memory')
