...
ColumnsSheet.commands += [
    Command('g+', 'addAggregators(selectedRows or source[0].nonKeyVisibleCols, chooseMany(aggregators))', 'add aggregator to selected source columns', 'column-aggregate-add-all'),
]
