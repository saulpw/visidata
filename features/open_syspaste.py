...
@BaseSheet.api
def open_syspaste(sheet, filetype=None):
    import io

    filetype = filetype or vd.input("paste as filetype: ", value='tsv')
...
BaseSheet.addCommand('gShift+P', 'open-syspaste', 'vd.push(open_syspaste())', 'open clipboard as filetype')
