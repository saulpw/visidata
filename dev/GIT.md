...
All PRs must include an [AI Level](ai-levels.md) (0-10) in the PR body. At level 4+, specify the model/version used. Always read `dev/ai-levels.md` to determine the correct level — don't guess.
