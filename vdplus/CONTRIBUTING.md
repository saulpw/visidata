Based on [Harmony (HA-CAA-I-ANY) Version 1.0](https://harmonyagreements.org/)

#  Individual Contributor Assignment Agreement

Thank you for your interest in contributing to a project by [Saul Pwanson](https://github.com/saulpw) ("We" or "Us").
...
"Contribution" means any work of authorship that is Submitted by You to Us in which You own or assert ownership of the Copyright. If You do not own the Copyright in the entire work of authorship, please follow the instructions in https://visidata.org/copyright.
...
(d) You have followed the instructions in https://visidata.org/copyright, if You do not own the Copyright in the entire work of authorship Submitted.
...
6.1  This Agreement will be governed by and construed in accordance with the laws of State of Washington excluding its conflicts of law provisions. Under certain circumstances, the governing law in this section might be superseded by the United Nations Convention on Contracts for the International Sale of Goods ("UN Convention") and the parties intend to avoid the application of the UN Convention to this Agreement and, thus, exclude the application of the UN Convention in its entirety to this Agreement.
